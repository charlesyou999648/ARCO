...
parser.add_argument('--root_path', type=str,
                    default='/data/data/Synapse', help='Name of Experiment')
...
parser.add_argument('--cut_size', type=int, default=64, help='the combination of transformation')
...
def patients_to_slices(dataset, patiens_num):
    ...
    if "ACDC" in dataset:
        ...
        ref_dict = {"1": 38, "2": 76, "5": 191, "10": 382, "100": 3823}
    elif "Syn" in dataset or "syn" in dataset: # class=8
        ref_dict = {"1": 44, "3": 66, "5": 111, "10": 221, "100": 2211}
    elif "Lits" in dataset or "LiTS" in dataset:
        ref_dict = {"1": 167, "5": 835, "10": 1668, "20": 3336, "50": 8340, "100": 16684}
...
def train(args, snapshot_path):
    ...
    if "Syn" in args.exp or "syn" in args.exp:
        db_train = Synapse_dataset(base_dir=args.root_path+'/data/Synapse/train_npz', split="train", transform=transforms.Compose([
            RandomGenerator(args.patch_size)
        ]), list_dir=args.root_path+'/data/lists_Synapse')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs, ema_output, ema_latent_logits, latent_logits, ema_output_logits, output_logits\
            ...
            if iter_num % 1000 == 0:
                modelToSave = model.model
                emaModelToSave = model.ema_model
                ...
                torch.save(emaModelToSave.state_dict(), save_mode_path)
