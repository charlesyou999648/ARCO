...
root = '/data/data/cityscapes'
im_root = '/data/data/cityscapes/images'
label_root = '/data/data/cityscapes/labels'
...
train_im_list = glob.glob(root + '/leftImg8bit/train/*')
counter = 0
...
val_im_list = glob.glob(root + '/leftImg8bit/val/*')
counter = 0
...
counter = 0
train_label_list = glob.glob(root + '/gtFine/train/*')
...
counter = 0
val_label_list = glob.glob(root + '/gtFine/val/*')
