...
if __name__ == '__main__':
    model = DeepLabv3Plus(models.resnet101(pretrained=True), num_classes=4)
    input = torch.rand(6, 3, 321, 321)
    prediction, representation = model(input)
    print(prediction.shape) # torch.Size([6, 4, 128, 128])
    print(representation.shape) # torch.Size([6, 256, 128, 128])
