        ...
        for y in range(0, sy):
            ...
            for z in range(0, sz):
                ...
                with torch.no_grad():
                    ...
                    # print('each test', test_patch.shape) # each test torch.Size([1, 1, 256, 224, 20])
                    # test_patch = test_patch.permute(0, 1, 4, 2, 3)
                    # exit()
                    y1 = net(test_patch)
                    # ensemble
                    y = torch.softmax(y1, dim=1)
                    # print('prediction', y.shape) # prediction torch.Size([1, 4, 20, 256, 224])
